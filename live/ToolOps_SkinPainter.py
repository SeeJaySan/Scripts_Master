...
class SkinOps_Painter(object):
    ...
    def __init__(self):
        ...
        self.selectTool_bn = mc.button( label='Select Tool', command=self.selectTool)        
        self.lassoTool_bn = mc.button( label='Lasso Tool', command=self.lassoTool)
        ...
        self.add_bn = mc.button( label='Add', command=self.add)        
        self.smooth_bn = mc.button( label='Smooth', command=self.smooth)
